...
public class BirtEngineFactory implements FactoryBean, ApplicationContextAware, DisposableBean {
	...
	public IReportEngine getObject() {
		...
		config.setLogConfig(null != this.resolvedDirectory ? this.resolvedDirectory.getAbsolutePath() : null,
				this.logLevel);
		// String format = HTMLRenderOption.OUTPUT_FORMAT_PDF;
		String format1 = HTMLRenderOption.OUTPUT_FORMAT_HTML;
		// String format2 = HTMLRenderOption.;
